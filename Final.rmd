...
Second, We can say that the vaccine does exhibit effectiveness in stopping COVID in women. The numeric data shows us that 35.07% women who contracted covid19 received the vaccine compared to the women who received the placebo which was 64.93%. Also, the p value  from the chi-squared test was 0.00000001914 which is less than 0.05 therefore we reject the null hypothesis. In addition, The odds of the vaccine being effective in women is about a 1.86 chance. Therefore, we can say the vaccine is effective in stopping COVID in women. 

Third, We can also say the vaccine is effective in stopping COVID in people who are LGBTQ. The numeric data shows that The numerical tables shows that 20% of people who are LGBTQ contracted COVID and also received the vaccine. The number of LGBTQ people who received the placebo was 80% which means the vaccine is effective in preventing COVID in people who are LGBTQ. The p-value from the chi-squared test is 0.000002266 which is less than 0.05, this means that we can reject the null hypothesis. On top of that, The odds ratio from the fisher's exact test is 4.27 which means the vaccine has a 4.27 chance of being effective in preventing COVID in people who are LGBTQ. Therefore, it is alright to say that that the vaccine is effective in stopping COVID in people who are LGBTQ. 
